...
import ftn.xml.korisnik.utils.AuthenticationUtilitiesMetadata;
import ftn.xml.korisnik.utils.SparqlUtil;
...
@Repository
public class RdfKorisnikRepository {

    private TransformerFactory transformerFactory;
    private static final String XSLT_FILE = "./src/main/resources/data/xslt/korisnik.xsl";

    private static final String SPARQL_NAMED_GRAPH_URI = "/korisnik/metadata";
    AuthenticationUtilitiesMetadata.ConnectionProperties conn;

    public RdfKorisnikRepository() {
