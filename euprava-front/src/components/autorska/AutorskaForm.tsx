                ...
                <div className="form-input-container">
                    <div id="licePodnosilac" className="grid grid-cols-2 gap-4"> 
                        ...
                        <div className='flex-col gap-1 items-start hidden' ref={pseudonimPodnosilac}>
                            ...
                            <input type="text"  name="drzavljanstvo" className='w-full' value={podnosilac.pseudonim} onChange = {e => setPodnosilac({...podnosilac, pseudonim:e.target.value})}/>                                        
                        </div>
            ...
            { autori.map((autor, index) =>
                    <div id="pronalazac" className="form-block relative" key={index}>
                        ...
                        <div className="flex items-center mb-4 col-span-2 self-start">
                                <input id="disabled-checkbox" type="checkbox" value="" className=" w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" checked={autor.anoniman}  onChange={e => changeAnonymity(index, e.target.checked)}/>
                        ...
                        { !autor.anoniman &&
                            ...
                            <div className="form-input-container">
                                ...
                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>Ime</p>
                                    <input type="text" name="ime-pronalazac" className='w-full' value={autor.info.ime} onChange={e => setAutor(index, {...autor, info:{...autor.info, ime: e.target.value}})}/>
                                </div>

                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>Prezime</p>
                                    <input type="text"  name="prezime-pronalazac" className='w-full' value={autor.info.prezime} onChange={e => setAutor(index, {...autor, info:{...autor.info, prezime: e.target.value}})}/>                                        
                                </div>

                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>Državljanstvo</p>
                                    <input type="text"  name="drzavljanstvo-pronalac" className='w-full' value={autor.info.drzavljanstvo} onChange={e => setAutor(index, {...autor, info:{...autor.info, drzavljanstvo: e.target.value}})}/>                                        
                                </div>

                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>Godina smrti</p>
                                    <input type="number"  name="drzavljanstvo-pronalac" className='w-full' value={autor.godinaSmrti} onChange={e => setAutor(index, {...autor, godinaSmrti: +e.target.value})}/>                                        
                                </div>

                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>Pseudonim</p>
                                    <input type="text"  name="drzavljanstvo-pronalac" className='w-full' value={autor.pseudonim} onChange={e => setAutor(index, {...autor, pseudonim: e.target.value})}/>                                        
                                </div>
                            ...
                            <div id="adresaPronalazac" className="grid grid-cols-3 gap-4">
                                ...
                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>Ulica</p>
                                    <input type="text" name="ulica-pronalazac" className='w-full' value={autor.adresa.ulica} onChange={e => setAutor(index, {...autor, adresa:{...autor.adresa, ulica: e.target.value}})}/>
                                </div>
                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>Broj</p>
                                    <input type="text"  name="broj-pronalazac" className='w-full' value={autor.adresa.broj} onChange={e => setAutor(index, {...autor, adresa:{...autor.adresa, broj: e.target.value}})}/>
                                </div>
                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>Poštanski broj</p>
                                    <input type="text"  name="postanskiBroj-pronalazac" className='w-full' value={autor.adresa.postanskiBroj} onChange={e => setAutor(index, {...autor, adresa:{...autor.adresa, postanskiBroj: e.target.value}})}/>
                                </div>
                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>Grad</p>
                                    <input type="text"  name="grad-pronalazac" className='w-full' value={autor.adresa.grad} onChange={e => setAutor(index, {...autor, adresa:{...autor.adresa, grad: e.target.value}})}/>
                                </div>
                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>Država</p>
                                    <input type="text"  name="drzava-pronalazac" className='w-full' value={autor.adresa.drzava} onChange={e => setAutor(index, {...autor, adresa:{...autor.adresa, drzava: e.target.value}})}/>
                                </div>
                            </div>
                            ...
                            <div id="kontaktPronalazac" className="grid grid-cols-3 gap-4">
                                ...
                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>Telefon</p>
                                    <input type="text" name="telefon-pronalazac" className='w-full' value={autor.kontakt.telefon} onChange={e => setAutor(index, {...autor, kontakt:{...autor.kontakt, telefon: e.target.value}})}/>
                                </div>
                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>E-pošta</p>
                                    <input type="text" name="eposta-pronalazac" className='w-full' value={autor.kontakt.eposta} onChange={e => setAutor(index, {...autor, kontakt:{...autor.kontakt, eposta: e.target.value}})}/>
                                </div>
                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>Faks</p>
                                    <input type="text"  name="faks-pronalazac" className='w-full' value={autor.kontakt.faks} onChange={e => setAutor(index, {...autor, kontakt:{...autor.kontakt, faks: e.target.value}})}/>
                                </div>
                            </div>
                        </div>
                        }
                ...
                <div id="punomocnik" className="form-block">
                    ...
                    <div className="form-input-container">
                        <div className="flex items-center mb-4 col-span-2 self-start">
                            <input id="disabled-checkbox" type="checkbox" checked={autorskoDelo.radniOdnos} onChange={e => setAutorskoDelo({...autorskoDelo, radniOdnos: e.target.checked})} className=" w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2"/>
                        ...
                        <div id="adresaDostavljanje" className="flex flex-col gap-4">
                            ...
                            <input type="text" name="ulica-dostavljanje" className='w-full' value={autorskoDelo.naslov} onChange={e => setAutorskoDelo({...autorskoDelo, naslov: e.target.value})}/>

                            <h2 className=" col-span-full"> Vrsta autorskog dela</h2>
                            <div className='flex gap-4 w-full'>
                                <select className="w-1/2 py-2.5 px-0 bg-transparent border-0 border-b-2 appearance-none focus:!outline-none focus:ring-0 border-gray-dark" value={autorskoDelo.vrstaDela ? autorskoDelo.vrstaDela : ''} onChange={e => setAutorskoDelo({...autorskoDelo, vrstaDela: e.target.value as VrstaDela, drugaVrsta:''})}>
                                    <option value=""></option>
                                ...
                                <div className='flex-col gap-1 items-start w-1/2'>
                                    ...
                                    <input type="text"  name="postanskiBroj-dostavljanje" className='w-full' value={autorskoDelo.drugaVrsta} onChange={e => setAutorskoDelo({...autorskoDelo, drugaVrsta: e.target.value, vrstaDela: null})}/>
                                </div>
                            </div>
                            
                            <h2 className=" w-full"> Forma autorskog dela</h2>
                            <input type="text" name="ulica-dostavljanje" className='w-full' value={autorskoDelo.forma} onChange={e => setAutorskoDelo({...autorskoDelo, forma: e.target.value})}/>
                            ...
                            <div className='flex gap-4 w-full'>
                                <div className='flex-col gap-1 items-start w-1/2'>
                                    ...
                                    <input type="text"  name="postanskiBroj-dostavljanje" className='w-full' value={autorskoDelo.naslovPrerade} onChange={e => setAutorskoDelo({...autorskoDelo, naslovPrerade: e.target.value})}/>
                                </div>
                                <div className='flex-col gap-1 items-start w-1/2'>
                                    <p className='font-light text-sm'>Ime autora:</p>
                                    <input type="text"  name="postanskiBroj-dostavljanje" className='w-full' value={autorskoDelo.imeAutoraPrerade} onChange={e => setAutorskoDelo({...autorskoDelo, imeAutoraPrerade: e.target.value})}/>
                                </div>
                            </div>


                            <h2 className=" w-full"> Način korišćenja</h2>
                            <input type="text" name="ulica-dostavljanje" className='w-full' value={autorskoDelo.nacinKoriscenja} onChange={e => setAutorskoDelo({...autorskoDelo, nacinKoriscenja: e.target.value})}/>                                                    
                        </div>
                    </div>
                </div>
                ...
                <div id="prilozi" className="form-block">
                    ...
                    <div className="form-input-container">
                        <div className="flex justify-between w-full items-center">
                            ...
                            <input type="file" name='opis-dela-fajl'  className="!border-none" onChange={e => setPrilozeniDokumenti({...prilozeniDokumenti, opisDela:e.target.files as FileList})}/>
                        </div>
                        <div className="flex justify-between w-full items-center">
                            <p>Primer autorskog dela:</p>
                            <input type="file" name='primer-fajl'  className="!border-none" onChange={e => setPrilozeniDokumenti({...prilozeniDokumenti, primerDela:e.target.files as FileList})}/>
                        </div>
                        <div className="flex justify-between w-full items-center">
                        ...
                        <div className="flex justify-between w-full items-center">
                            ...
                            <input type="file" name='izjava-pravni-osnov-fajl' className="!border-none" onChange={e => setPrilozeniDokumenti({...prilozeniDokumenti, pravniOsnov:e.target.files as FileList})}/>
                        </div>
                        <div className="flex justify-between w-full items-center">
                            <p>Izjava o zajedničkom predstavniku:</p>
                            <input type="file" name='zajednicki-predstavnik-fajl' className="!border-none" onChange={e => setPrilozeniDokumenti({...prilozeniDokumenti, zajednickiPredstavnik:e.target.files as FileList})}/>
                        </div>
                        <div className="flex justify-between w-full items-center">
                            <p>Punomoćje:</p>
