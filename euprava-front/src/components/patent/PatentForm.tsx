            ...
            <form className="flex flex-col gap-5">
                <div id="naziv-patenta" className="form-block">
                    ...
                    <div className="flex justify-between items-center w-full">
                        ...
                        <input type="text" name="naziv-srpski" className='w-3/4' value={nazivPatenta.srpski} onChange={e => setNazivPatenta({...nazivPatenta, srpski:e.target.value})}/>
                    </div>
                    <div className="flex justify-between items-center w-full">
                        <p>Naziv na engleskom:</p>
                        <input type="text" name="naziv-engleski" className='w-3/4' value={nazivPatenta.engleski} onChange={e => setNazivPatenta({...nazivPatenta, engleski:e.target.value})}/>
                    </div>
                </div>
                    ...
                    <div className="form-input-container">
                        <div id="licePodnosilac" className="grid grid-cols-2 gap-4"> 
                            ...
                            <div className="flex items-center mb-4 col-span-2 self-start">
                                <input id="disabled-checkbox" type="checkbox" checked={podnosilac.pronalazac} onChange={e => setPodnosilac({...podnosilac, pronalazac: e.target.checked})} className=" w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2"/>
                            ...
                            <div className='flex-col gap-1 items-start hidden' ref={citizenshipPodnosilac}>
                                ...
                                <input type="text"  name="drzavljanstvo" className='w-full' value={podnosilac.info.drzavljanstvo} onChange = {e => setPodnosilac({...podnosilac, info:{...podnosilac.info, drzavljanstvo:e.target.value}})}/>                                        
                            </div>
                ...
                <div className="flex items-center mb-4 col-span-2 self-start">
                    <input id="disabled-checkbox-pronalazac" type="checkbox" checked={pronalazaciNavedeni} onChange={e => setPronalazaciNavedeni(e.target.checked)} className=" w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2"/>
                    <label htmlFor="disabled-checkbox-pronalazac" className="ml-2 text-base">Pronalazač želi da bude naveden</label>
                </div>
                        ...
                        <div className="form-input-container">
                            <div id="licePronalazac" className="grid grid-cols-2 gap-4"> 
                                ...
                                <div className='flex-col gap-1 items-start hidden'  ref={namePronalazac}>
                                    <p className='font-light text-sm'>Ime</p>
                                    <input type="text" name="ime-pronalazac" className='w-full' value={pronalazac.info.ime} onChange = {e => setPronalazac(index, {...pronalazac, info:{...pronalazac.info, ime:e.target.value}})}/>
                                </div>

                                <div className='flex-col gap-1 items-start hidden' ref={surnamePronalazac}>
                                    <p className='font-light text-sm'>Prezime</p>
                                    <input type="text"  name="prezime-pronalazac" className='w-full' value={pronalazac.info.prezime} onChange = {e => setPronalazac(index, {...pronalazac, info:{...pronalazac.info, prezime:e.target.value}})}/>                                        
                                </div>

                                <div className='flex-col gap-1 items-start hidden' ref={citizenshipPronalazac}>
                                    <p className='font-light text-sm'>Državljanstvo</p>
                                    <input type="text"  name="drzavljanstvo-pronalac" className='w-full' value={pronalazac.info.drzavljanstvo} onChange = {e => setPronalazac(index, {...pronalazac, info:{...pronalazac.info, drzavljanstvo:e.target.value}})}/>                                        
                                </div>
                            ...
                            <div id="adresaPronalazac" className="grid grid-cols-3 gap-4">
                                ...
                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>Ulica</p>
                                    <input type="text" name="ulica-pronalazac" className='w-full' value={pronalazac.adresa.ulica} onChange = {e => setPronalazac(index, {...pronalazac, adresa:{...pronalazac.adresa, ulica:e.target.value}})}/>
                                </div>
                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>Broj</p>
                                    <input type="text"  name="broj-pronalazac" className='w-full' value={pronalazac.adresa.broj} onChange = {e => setPronalazac(index, {...pronalazac, adresa:{...pronalazac.adresa, broj:e.target.value}})}/>
                                </div>
                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>Poštanski broj</p>
                                    <input type="text"  name="postanskiBroj-pronalazac" className='w-full' value={pronalazac.adresa.postanskiBroj} onChange = {e => setPronalazac(index, {...pronalazac, adresa:{...pronalazac.adresa, postanskiBroj:e.target.value}})}/>
                                </div>
                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>Grad</p>
                                    <input type="text"  name="grad-pronalazac" className='w-full' value={pronalazac.adresa.grad} onChange = {e => setPronalazac(index, {...pronalazac, adresa:{...pronalazac.adresa, grad:e.target.value}})}/>
                                </div>
                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>Država</p>
                                    <input type="text"  name="drzava-pronalazac" className='w-full' value={pronalazac.adresa.drzava} onChange = {e => setPronalazac(index, {...pronalazac, adresa:{...pronalazac.adresa, drzava:e.target.value}})}/>
                                </div>
                            </div>
                            ...
                            <div id="kontaktPronalazac" className="grid grid-cols-3 gap-4">
                                ...
                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>Telefon</p>
                                    <input type="text" name="telefon-pronalazac" className='w-full' value={pronalazac.kontakt.telefon} onChange = {e => setPronalazac(index, {...pronalazac, kontakt:{...pronalazac.kontakt, telefon:e.target.value}})}/>
                                </div>
                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>E-pošta</p>
                                    <input type="text" name="eposta-pronalazac" className='w-full' value={pronalazac.kontakt.eposta} onChange = {e => setPronalazac(index, {...pronalazac, kontakt:{...pronalazac.kontakt, eposta:e.target.value}})}/>
                                </div>
                                <div className='flex-col gap-1 items-start'>
                                    <p className='font-light text-sm'>Faks</p>
                                    <input type="text"  name="faks-pronalazac" className='w-full' value={pronalazac.kontakt.faks} onChange = {e => setPronalazac(index, {...pronalazac, kontakt:{...pronalazac.kontakt, faks:e.target.value}})}/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="punomocnik" className="form-block">
                    ...
                    <div id="vrstaPunomocnik" className="grid grid-cols-3 gap-4 col-span-2">
                        ...
                        <div className="flex items-center mb-4 self-start">
                            <input id="disabled-checkbox-punomocnik" type="checkbox" checked={punomocnik.zaPrijem} className=" w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" onChange={e => setPronalazacType('prijem', e.target.checked)}/>
                            <label htmlFor="disabled-checkbox-punomocnik" className="ml-2 text-base">Punomocnik za prijem pismena</label>
                        </div>
                        <div className="flex items-center mb-4 self-start">
                            <input id="disabled-checkbox-punomocnik" type="checkbox"  checked={punomocnik.zaZastupanje} className=" w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" onChange={e => setPronalazacType('zastupanje', e.target.checked)}/>
                            <label htmlFor="disabled-checkbox-punomocnik" className="ml-2 text-base">Punomocnik za zastupanje</label>
                        </div>
                        <div className="flex items-center mb-4 self-start">
                            <input id="disabled-checkbox-punomocnik" type="checkbox" checked={punomocnik.zajednickiPredstavnik}  className=" w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" onChange={e => setPronalazacType('predstavnik', e.target.checked)}/>
                    ...
                    <div className="form-input-container">
                        <div id="licePunomocnik" className="grid grid-cols-2 gap-4"> 
                            ...
                            <div className='flex-col gap-1 items-start hidden' ref={citizenshipPunomocnik}>
                                <p className='font-light text-sm'>Državljanstvo</p>
                                <input type="text"  name="drzavljanstvo-punomocnik" className='w-full' value={punomocnik.info.drzavljanstvo} onChange = {e => setPunomocnik({...punomocnik, info:{...punomocnik.info, drzavljanstvo:e.target.value}})}/>                                        
                            </div>
                        </div>
                        ...
                        <div id="kontaktPunomocnik" className="grid grid-cols-3 gap-4">
                            ...
                            <div className='flex-col gap-1 items-start'>
                                <p className='font-light text-sm'>E-pošta</p>
                                <input type="text" name="eposta-punomocnik" className='w-full' value={punomocnik.kontakt.eposta} onChange = {e => setPunomocnik({...punomocnik, kontakt:{...punomocnik.kontakt, eposta:e.target.value}})}/>
                            </div>
                            <div className='flex-col gap-1 items-start'>
                                <p className='font-light text-sm'>Faks</p>
                ...
                <div id="punomocnik" className="form-block">
                    ...
                    <div className="form-input-container">
                        <div id="adresaDostavljanje" className="grid grid-cols-3 gap-4">
                            ...
                            <div className='flex-col gap-1 items-start'>
                                <p className='font-light text-sm'>Ulica</p>
                                <input type="text" name="ulica-dostavljanje" className='w-full' value={dostavljanje.ulica} onChange={e => setDostavljanje({...dostavljanje, ulica: e.target.value})}/>
                            </div>
                            <div className='flex-col gap-1 items-start'>
                                <p className='font-light text-sm'>Broj</p>
                                <input type="text"  name="broj-dostavljanje" className='w-full' value={dostavljanje.broj} onChange={e => setDostavljanje({...dostavljanje, broj: e.target.value})}/>
                            </div>
                            <div className='flex-col gap-1 items-start'>
                                <p className='font-light text-sm'>Poštanski broj</p>
                                <input type="text"  name="postanskiBroj-dostavljanje" className='w-full' value={dostavljanje.postanskiBroj} onChange={e => setDostavljanje({...dostavljanje, postanskiBroj: e.target.value})}/>
                            </div>
                            <div className='flex-col gap-1 items-start'>
                                <p className='font-light text-sm'>Grad</p>
                                <input type="text"  name="grad-dostavljanje" className='w-full' value={dostavljanje.grad} onChange={e => setDostavljanje({...dostavljanje, grad: e.target.value})}/>
                            </div>
                            <div className='flex-col gap-1 items-start'>
                                <p className='font-light text-sm'>Država</p>
                                <input type="text"  name="drzava-dostavljanje" className='w-full' value={dostavljanje.drzava} onChange={e => setDostavljanje({...dostavljanje, drzava: e.target.value})}/>
                            </div>
                        </div>
                        ...
                        <div id="licePodnosilac" className="grid grid-cols-2 gap-4"> 
                            ...
                            <div className="flex items-center mr-4">
                                <input type="radio" name="podnosilac-radio" className="w-4 h-4" checked={dostavljanje.pisano} onChange={e => setDostavljanje({...dostavljanje, pisano: e.target.checked, elektronski: !e.target.checked})}/>
                                <label>Pisano</label>
                            </div>
                            <div className="flex items-center mr-4 ml-9">
                                <input type="radio" value="" name="podnosilac-radio" className="w-4 h-4"  checked={dostavljanje.elektronski} onChange={e => setDostavljanje({...dostavljanje, elektronski: e.target.checked, pisano: !e.target.checked})}/>
                ...
                <div id="prvobitna-prijava" className="form-block">
                    ...
                    <table className="w-[90%] h-48">
                        ...
                        <tr>
                            ...
                            <td className='w-3/5'>
                                <input type="text" placeholder="P-" name='prvobitna-prijava-broj' className='w-full' value={prvobitnaPrijava.brojPrijave} onChange={e => setPrvobitnaPrijava({...prvobitnaPrijava, brojPrijave: e.target.value})}/>
                            </td>
                        </tr>                      
                        <tr className='align-baseline'>
                            <td className='flex items-end'>Datum podnošenja:</td>
                            <td className='w-3/5'>
                                <input type="date" className="w-full" name='prvobitna-prijava-datum' value={prvobitnaPrijava.datum} onChange={e => setPrvobitnaPrijava({...prvobitnaPrijava, datum: e.target.value})}/>
                            </td>
                        </tr>
                        <tr>
                            <td className='flex items-end'>Tip prijave koja se podnosi:</td>
                            <td className='w-3/5 align-baseline'>
                                <select className="w-full p-1" name='tip-prvobitne-prijave' value={prvobitnaPrijava.tip} onChange={e => setPrvobitnaPrijava({...prvobitnaPrijava, tip: e.target.value as TipPrvobitnePrijave})}>
                    ...
                    <table className="w-[90%] border-separate border-spacing-3">
                        ...
                        {  ranijePrijave.map((application, index) =>                   
                            <tr key={index}>
                                ...
                                <td>
                                    <input type="text" placeholder="P-" name={`ranija-prijava-broj-${index}`} className='w-full' value={application.brojPrijave} onChange = {e => setRanijaPrijava(index, {...application, brojPrijave:e.target.value})}/>
                                </td>
                                <td>
                                    <input type="date" className="w-full" name={`ranija-prijava-datum-${index}`} value={application.datum} onChange = {e => setRanijaPrijava(index, {...application, datum:e.target.value})}/>
                                </td>
                                <td>
                                    <input type="input" className="w-full" name={`ranija-prijava-oznaka-${index}`} value={application.oznaka} onChange = {e => setRanijaPrijava(index, {...application, oznaka:e.target.value})}/>
                                </td>
                                <td>
                ...
                <div id="prilozi" className="form-block">
                    ...
                    <div className="form-input-container">
                        <div className="flex justify-between w-full items-center">
                            ...
                            <input type="file" name='prvobitna-prijava-fajl' className="!border-none" onChange={e => setPrilozeniDokumenti({...prilozeniDokumenti, prvobitnaPrijava:e.target.files as FileList})}/>
                        </div>
                        <div className="flex justify-between w-full items-center">
                            <p>Ranije prijave:</p>
                            <input type="file" name='ranije-prijave-fajl' multiple className="!border-none" onChange={e => setPrilozeniDokumenti({...prilozeniDokumenti, ranijePrijave:e.target.files as FileList})}/>
                        </div>
                        <div className="flex justify-between w-full items-center">
                            <p>Izjava o osnovu sticanja prava na podnosenje prijave:</p>
                            <input type="file" name='osnova-sticanja-prava-fajl'  className="!border-none" onChange={e => setPrilozeniDokumenti({...prilozeniDokumenti, osnovSticanja:e.target.files as FileList})}/>
                        </div>
                        <div className="flex justify-between w-full items-center">
                            <p>Izjava pronalazaca da ne zeli da bude naveden:</p>
                            <input type="file" name='izjava-pronalazaca-fajl'  className="!border-none" onChange={e => setPrilozeniDokumenti({...prilozeniDokumenti, nenavedenPronalazac:e.target.files as FileList})}/>
                        </div>
                        <div className="flex justify-between w-full items-center">
                            <p>Opis pronalaska:</p>
                            <input type="file" name='opis-pronalaska-fajl' className="!border-none" onChange={e => setPrilozeniDokumenti({...prilozeniDokumenti, opisPronalaska:e.target.files as FileList})}/>
                        </div>
                        <div className="flex justify-between w-full items-center">
                            <p>Patent zahtevi za zastitu pronalaska:</p>
                            <input type="file" name='patent-zahtevi-fajl' className="!border-none" onChange={e => setPrilozeniDokumenti({...prilozeniDokumenti, zastitaPronalaska:e.target.files as FileList})}/>
                        </div>
                        <div className="flex justify-between w-full items-center">
                            <p>Nacrt na koji se poziva opis:</p>
                            <input type="file" name='nacrt-fajl' className="!border-none" onChange={e => setPrilozeniDokumenti({...prilozeniDokumenti, nacrt:e.target.files as FileList})}/>
                        </div>
                        <div className="flex justify-between w-full items-center">
                            <p>Apstrakt:</p>
                            <input type="file" name='apstrakt-fajl' className="!border-none" onChange={e => setPrilozeniDokumenti({...prilozeniDokumenti, apstrakt:e.target.files as FileList})}/>
                        </div>                       
                    </div>
                </div>
