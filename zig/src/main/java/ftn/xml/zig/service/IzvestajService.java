...
public class IzvestajService {
    ...
    public static final String CONTEXT_PATH = "ftn.xml.zig.model.izvestaj";
    ...
    public String getIzvestajPdf(ftn.xml.zig.model.izvestaj.Izvestaj izvestaj, String fileName) throws JAXBException {
        return toPDF(marshal(izvestaj), fileName);
    }

    public String getResnjePdf(ZahtevZaPriznanjeZiga.Resenje resenje, String fileName) throws JAXBException {
        return toPDF(marshalResenje(resenje), fileName);
    }

    public OutputStream marshal(ftn.xml.zig.model.izvestaj.Izvestaj izvestaj) throws JAXBException {
