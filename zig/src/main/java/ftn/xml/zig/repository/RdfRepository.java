...
import ftn.xml.zig.utils.SparqlUtil;
...
public class RdfRepository {
    ...
    private static final String XSLT_FILE = "./src/main/resources/data/xslt/zig.xsl";

    private static final String SPARQL_NAMED_GRAPH_URI = "/zig/metadata";
