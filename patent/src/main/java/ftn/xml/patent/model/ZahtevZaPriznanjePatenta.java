 ...
 *                   &lt;element name="Patentn_zahtevi_za_zastitu_pronalaska" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/>
...
public class ZahtevZaPriznanjePatenta {
    ...
    public static class PopunjavaPodnosioc {
        ...
        protected List<PodaciOPodnosiocu> podaciOPodnosiocu;
         ...
         * 
         */
        public List<PodaciOPodnosiocu> getPodaciOPodnosiocu() {
            if (podaciOPodnosiocu == null) {
                podaciOPodnosiocu = new ArrayList<PodaciOPodnosiocu>();
            }
    ...
    @XmlType(name = "", propOrder = {
        ...
        "opisPronalaska",
        "patentnZahteviZaZastituPronalaska",
    ...
    public static class PriloziUzZahtev {
        ...
        @XmlElement(name = "Patentn_zahtevi_za_zastitu_pronalaska", required = true)
        protected List<String> patentnZahteviZaZastituPronalaska;
        ...
        /**
         * Gets the value of the patentnZahteviZaZastituPronalaska property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the patentnZahteviZaZastituPronalaska property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getPatentnZahteviZaZastituPronalaska().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<String> getPatentnZahteviZaZastituPronalaska() {
            if (patentnZahteviZaZastituPronalaska == null) {
                patentnZahteviZaZastituPronalaska = new ArrayList<String>();
            }
            return this.patentnZahteviZaZastituPronalaska;
        }
